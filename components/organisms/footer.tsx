...
export default function Footer() {
    ...
    const footerData = [
        ...
        {
            icon: <IoMdMail className="mt-[0.03rem] text-red-500"/>,
        ...
        },
        {
            ...
            address: 'Jl. Jend. Sudirman Kav 45-46, Karet Semanggi,',
                            ...
                            <div className="flex flex-col md:ml-[2rem] text-[#4D4D4D] mt-[0.2rem]">
                                ...
                                <div className="flex flex-col gap-[0.1rem] mt-[0.2rem]">
                                    {links.map((item, index) => {
                                        const isActive = pathname === item.path ? 'text-red-500' : 'text-[#4D4D4D]';
                                        return(
