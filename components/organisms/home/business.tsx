        ...
        <div className="bg-[#d13333] skl-container py-[0.35rem] md:py-[0.7rem] px-[0.1rem] sm:px-[0.2rem] md:px-[0.7rem] animation-effect">
            <div className='flex flex-col'>
                <div className="w-full flex justify-between items-center">
                    ...
                    <button className="md:block hidden cursor-pointer font-medium text-[#d13333] bg-white text-[0.15rem] md:text-[0.2rem] px-[0.2rem] md:px-[0.3rem] py-[0.08rem] md:py-[0.15rem]">See More</button>
                </div>
