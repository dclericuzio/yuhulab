...
export default function About() {
    return (
        <div id='tentangkami' className="skl-container py-[0.35rem] md:py-[0.7rem] px-[0.3rem] md:px-[0.7rem] animation-effect">
