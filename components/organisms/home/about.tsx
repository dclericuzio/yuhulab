export default function About() {
    return (
        <div className="skl-container py-[0.35rem] md:py-[0.7rem] px-[0.3rem] sm:px-[0.2rem] md:px-[0.7rem] animation-effect">
            <div className='justify-center flex flex-col w-full'>
                <span className='text-center mb-[0.1rem] md:mb-[0.2rem] text-[0.3rem] md:text-[0.5rem] font-semibold animation-effect'>About us</span>
                <div className="flex md:flex-row flex-col md:text-center text-justify justify-center">
                    <div className="md:w-2/3 flex flex-col">
                        <div className="text-[0.15rem] md:text-[0.2rem] text-[#4D4D4D]">PT Sejahtera Karunia Lines (PT SKL) was established in 2012 as a subsidiary of PT Samudra Berkat Shipping. We are registered, licensed and in operational within Indonesian maritime freight transportation, empowered with strong commitment to support the growth of national logistics distribution & downstream.</div>
