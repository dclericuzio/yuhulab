        ...
        <div className="skl-container pb-[0.35rem] md:py-[0.7rem] px-[0.3rem] md:px-[0.7rem] animation-effect">
            ...
            <div className='flex flex-col md:flex-row w-full md:gap-[1rem] mb-[0.1rem] md:mb-[0.7rem]'>
                <div className="flex flex-col md:w-2/3">
                    <span className='mb-[0.1rem] md:mb-[0.2rem] text-[0.25rem] md:text-[0.35rem] font-bold animation-effect'>Profil Perusahaan</span>
            ...
            <div className='flex flex-col md:flex-row w-full items-center mb-[0.1rem] md:mb-[0.7rem]'>
                <div className="flex flex-col">
                    <div className="md:w-2/3 flex flex-col">
                        <span className='mb-[0.1rem] md:mb-[0.2rem] text-[0.25rem] md:text-[0.35rem] font-bold animation-effect'>Visi, Misi, dan Nilai-Nilai Perusahaan</span>
                        <div className="flex flex-col text-justify mb-[0.1rem] md:mb-[0.2rem]">
                            ...
                            <div className="text-[0.15rem] text-[#4D4D4D]">Menjadi perusahaan angkutan laut dalam negeri terdepan dan terpercaya dalam layanan pengangkutan barang khusus, dengan standar keselamatan, keandalan, dan keberlanjutan tertinggi di Indonesia.</div>
                        </div>
                        <div className="flex flex-col text-justify mb-[0.1rem] md:mb-[0.2rem]">
                            <span className="text-[0.15rem] md:text-[0.2rem] mb-[0.1rem] md:mb-[0.2rem]">Misi</span>
                            <ul className="list-disc list-inside text-[0.15rem] text-[#4D4D4D]">
                    ...
                    <div className="flex flex-col text-justify mb-[0.1rem] md:mb-[0.2rem]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 bg-gradient-to-t from-[#e3eaf3] to-[#e3eaf340] gap-[0.01rem] md:py-[0.25rem]">
                            {Value.map((item, index) => (
                                <div 
                                    key={index}
                                    className={`flex flex-col py-[0.075rem] mx-[0.075rem] md:px-[0.25rem] ${
            ...
            <div className='flex flex-col md:flex-row w-full items-center'>
                <div className="flex flex-col">
                    <span className='mb-[0.1rem] md:mb-[0.2rem] text-[0.25rem] md:text-[0.35rem] font-bold animation-effect'>Manajemen Perusahaan</span>
                    <div className="flex md:flex-row flex-col-reverse items-center  mb-[0.3rem] md:mb-[0.7rem]">
                        <div className="md:w-2/3 flex flex-col">
                            <div className="flex flex-col text-justify mb-[0.1rem] md:mb-[0.2rem]">
                                ...
                                <div className="text-[0.15rem] text-[#4D4D4D] flex flex-col gap-[0.1rem]">
