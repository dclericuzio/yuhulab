            ...
            <div className="flex flex-col mb-[0.1rem] md:mb-[1rem] ">    
                <div className="flex flex-col-reverse md:flex-row items-center gap-[0.2rem]">
                    <div className='flex flex-col'>
                        <span className='mb-[0.1rem] md:mb-[0.2rem] text-[0.3rem] md:text-[0.5rem] font-medium animation-effect'>Profile</span>
                        ...
                        <div className="mb-[0.1rem] md:mb-[0.2rem] text-[0.15rem] md:text-[0.2rem] text-[#4D4D4D]">PTSKL owns and has extensive experiences in Shipment Operations & Ship Management Services for Dry-Bulk, Liquid & special cargo consisting of Mother Vessels (MV), Self-Propelled Barges (SPB), Tug and Barge (T&B), and Oil Barges (OB).</div>
                    </div>
                </div>
            </div>
        </div>
